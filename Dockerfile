...
ENV GROMMUNIO_DAV_VERSION=${GROMMUNIO_DAV_VERSION:-"94260cb4c7d7249af282799521a810f956671fe2"} \
    GROMMUNIO_MAPI_HEADERS_VERSION=${GROMMUNIO_MAPI_HEADERS_VERSION:-"1.4"} \
